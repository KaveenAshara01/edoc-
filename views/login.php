    ...
    <div class="container">
        <table border="0" style="margin: 0;padding: 0;width: 60%;">
            ...
            <div class="form-body">
                ...
                <tr>
                    <td><br><?php echo isset($error) ? $error : '&nbsp;'; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><br><label for="" class="sub-text">Don't have an account&#63; </label><a href="signup.php" class="hover-link1 non-style-link">Sign Up</a></td>
                </tr>
            </form>
        </table>
    </div>
