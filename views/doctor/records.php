...
<body>
    ...
    <tr>
        <td width="50%">
            <form action="../../controllers/RecordController.php?action=addRecordForm" method="get">
                <!-- Passing patient ID as a hidden field -->
                <input type="hidden" name="pid" value="<?= $pid; ?>">
                <input type="hidden" name="action" value="addRecordForm">
